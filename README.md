...
The Plotting_VGC_maze script contains all the code necessary to visualize the maze stimuli and test for differences in nuissance covariates. This script requires the vgc python package. 
