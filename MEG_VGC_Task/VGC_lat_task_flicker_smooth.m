...
trialMatrix.Respond = repelem([1,0,0],64)';
...
%------------------------------------------------------------------------------------------
                ...
                colour_stims_2=colour_stims(:,index_relv);
                colour_stims_2(1,:)= 0.25;
                colour_stims_2(2,:)= 0.25;
                colour_stims_2(3,:)= 1;

                colour_stims_3=colour_stims(:,index_relv);
                colour_stims_3(1,:)= 0.5;
                colour_stims_3(2,:)= 0.5;
                colour_stims_3(3,:)= 1;
                ...
                colour_stims_4=colour_stims(:,index_relv);
                colour_stims_4(1,:)= 0.75;
                colour_stims_4(2,:)= 0.75;
                colour_stims_4(3,:)= 1;

                colour_stims_5=colour_stims(:,index_relv);
                colour_stims_5(1,:)= 0.66;
                colour_stims_5(2,:)= 0.66;
                colour_stims_5(3,:)= 1;

                colour_stims_6=colour_stims(:,index_relv);
                colour_stims_6(1,:)= 0.33;
                colour_stims_6(2,:)= 0.33;
                colour_stims_6(3,:)= 1;

                planningphase_rel= cell([1, round(6000/RefreshRate)]);
                planningphase_rel(:) = {colour_stims(:,index_relv)};

                planningphase_rel(1:7:end)={colour_stims_1};
                planningphase_rel(2:7:end)={colour_stims_2};
                planningphase_rel(3:7:end)={colour_stims_3};
                planningphase_rel(4:7:end)={colour_stims_4};
                planningphase_rel(5:7:end)={colour_stims_9};
                planningphase_rel(6:7:end)={colour_stims_5};
                planningphase_rel(7:7:end)={colour_stims_6};
                ...
                colour_stims_2=colour_stims(:,index_irrelv);
                colour_stims_2(1,:)= 0.33;
                colour_stims_2(2,:)= 0.33;
                colour_stims_2(3,:)= 1;

                colour_stims_3=colour_stims(:,index_irrelv);
                colour_stims_3(1,:)= 0.66;
                colour_stims_3(2,:)= 0.66;
                colour_stims_3(3,:)= 1;
                ...
                colour_stims_4=colour_stims(:,index_irrelv);
                colour_stims_4(1,:)= 0.66;
                colour_stims_4(2,:)= 0.66;
                colour_stims_4(3,:)= 1;

                colour_stims_5=colour_stims(:,index_irrelv);
                colour_stims_5(1,:)= 0.33;
                colour_stims_5(2,:)= 0.33;
                colour_stims_5(3,:)= 1;
                ...
                planningphase_irrel(2:6:end)={colour_stims_2};
                planningphase_irrel(3:6:end)={colour_stims_3};
                planningphase_irrel(4:6:end)={colour_stims_9};
                planningphase_irrel(5:6:end)={colour_stims_4};
                planningphase_irrel(6:6:end)={colour_stims_5};
...
%------------------------------------------------------------------------------------------
                ...
                planningphase_rel(6:7:end)={colour_stims_5};
                planningphase_rel(7:7:end)={colour_stims_6};
                propixxphoto(1:7:end)=propixxphoto(1:7:end)+1;
                photodiode(1:7:end)=255;
                ...
                planningphase_irrel(5:6:end)={colour_stims_4};
                planningphase_irrel(6:6:end)={colour_stims_5};
                propixxphoto(1:6:end)=propixxphoto(1:6:end)+2;
                photodiode2(1:6:end)=255;
                ...
                %--------------------------------------------------------------------                        
                    ...
                    Screen('DrawDots', mainWin, [centerX+centerXhalf, centerY-15+centerYhalf], 7, black, [], 2)
                       ...
                       % propixx pixel
                        Screen('FillRect',mainWin,[propixxphoto(f),propixxphoto(f),propixxphoto(f)],[0;0;3;3]); 
                        Screen('FillRect',mainWin,[propixxphoto(f+1),propixxphoto(f+1),propixxphoto(f+1)],[0+xCenter;0;3+xCenter;3]); 
                        Screen('FillRect',mainWin,[propixxphoto(f+2),propixxphoto(f+2),propixxphoto(f+2)],[0;0+yCenter;3;3+yCenter]);
                         Screen('FillRect',mainWin,[propixxphoto(f+3),propixxphoto(f+3),propixxphoto(f+3)],[0+xCenter;0+yCenter;3+xCenter;3+yCenter]); 
                       
                         % photo diode
                        Screen('FillRect',mainWin,[photodiode(f),photodiode(f),photodiode(f)],[0;530;10;540]); 
                        Screen('FillRect',mainWin,[photodiode(f+1),photodiode(f+1),photodiode(f+1)],[0+xCenter;530;10+xCenter;540]); 
                        Screen('FillRect',mainWin,[photodiode(f+2),photodiode(f+2),photodiode(f+2)],[0;530+yCenter;10;540+yCenter]); 
                         Screen('FillRect',mainWin,[photodiode(f+3),photodiode(f+3),photodiode(f+3)],[0+xCenter;530+yCenter;10+xCenter;540+yCenter]); 

                        % photo diode2
                        Screen('FillRect',mainWin,[photodiode2(f),photodiode2(f),photodiode2(f)],[950;530;960;540]); 
                        Screen('FillRect',mainWin,[photodiode2(f+1),photodiode2(f+1),photodiode2(f+1)],[950+xCenter;530;960+xCenter;540]); 
                        Screen('FillRect',mainWin,[photodiode2(f+2),photodiode2(f+2),photodiode2(f+2)],[950;530+yCenter;960;540+yCenter]); 
                        Screen('FillRect',mainWin,[photodiode2(f+3),photodiode2(f+3),photodiode2(f+3)],[950+xCenter;530+yCenter;960+xCenter;540+yCenter]); 
